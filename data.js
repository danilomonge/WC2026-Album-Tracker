...
// Emojis de bandera por código de selección (para cabeceras de equipo en el álbum).
...
export const TEAM_FLAG_STYLES = {
  ...
  RSA: "linear-gradient(145deg, transparent 0 30%, #ffb612 30% 35%, #ffffff 35% 40%, #007a4d 40% 60%, #ffffff 60% 65%, #000000 65% 70%, transparent 70%), linear-gradient(to bottom, #de3831 0 50%, #002395 50% 100%)",
  KOR: "radial-gradient(circle at 50% 43%, #cd2e3a 0 13%, #0047a0 13% 26%, #ffffff 26% 100%)",
  CZE: "linear-gradient(150deg, #11457e 0 36%, transparent 36%), linear-gradient(to bottom, #ffffff 0 50%, #d7141a 50% 100%)",
  CAN: "linear-gradient(to right, #d52b1e 0 25%, #ffffff 25% 75%, #d52b1e 75% 100%)",
  BIH: "linear-gradient(145deg, #fcd116 0 7%, transparent 7% 100%), linear-gradient(145deg, #002f6c 0 78%, #fcd116 78% 84%, #002f6c 84% 100%)",
  QAT: "linear-gradient(90deg, #ffffff 0 38%, #8a1538 38% 100%)",
